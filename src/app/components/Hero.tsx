    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div ref={parallaxRef} className="absolute inset-0 transition-transform duration-100 ease-out">
        <div className="absolute inset-0" style={{
          background: 'linear-gradient(135deg, var(--bg) 0%, #0a0a0a 40%, #1a0f0a 70%, var(--bg) 100%)'
        }} />
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        ...
        <h1 className="text-6xl sm:text-8xl lg:text-[10rem] font-black tracking-tighter leading-[0.85] mb-8">
          <span className="block" style={{ color: 'var(--text)' }}>DEFINE</span>
          <span className="block italic font-serif font-normal tracking-wide" style={{ color: 'var(--accent)' }}>Your</span>
          <span className="block" style={{ color: 'var(--text)' }}>EDGE</span>
        </h1>

        <p className="text-base sm:text-lg max-w-xl mx-auto mb-12 leading-relaxed" style={{ color: 'var(--text-muted)' }}>
          Where raw craftsmanship meets contemporary design. 
          Every piece is forged for those who demand more than the ordinary.
        </p>
        ...
        <div className="flex items-center justify-center gap-8 sm:gap-16 mt-16">
          {['Free Shipping', '30-Day Returns', 'Premium Quality'].map((badge) => (
