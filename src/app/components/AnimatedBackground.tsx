...
export function AnimatedBackground() {
  ...
  return (
    <div className="terrain-ground" style={{ opacity: isDark ? 0.15 : 0.08 }}>
      <svg ref={svgRef} viewBox="0 0 1920 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full" preserveAspectRatio="none">
        ...
        <defs>
          <linearGradient id="terrain-gradient" x1="0" y1="160" x2="1920" y2="160">
            <stop offset="0%" stopColor="var(--accent)" stopOpacity={isDark ? 0.3 : 0.4} />
            <stop offset="50%" stopColor="var(--accent)" stopOpacity={isDark ? 0.1 : 0.15} />
            <stop offset="100%" stopColor="var(--accent)" stopOpacity={isDark ? 0.3 : 0.4} />
          </linearGradient>
          <linearGradient id="terrain-gradient-2" x1="0" y1="200" x2="1920" y2="200">
            <stop offset="0%" stopColor="var(--accent)" stopOpacity={isDark ? 0.15 : 0.2} />
            <stop offset="50%" stopColor="var(--accent)" stopOpacity={isDark ? 0.05 : 0.08} />
            <stop offset="100%" stopColor="var(--accent)" stopOpacity={isDark ? 0.15 : 0.2} />
          </linearGradient>
        </defs>
      </svg>
    </div>
      ...
      {Array.from({ length: 20 }).map((_, i) => (
        <div
          ...
          style={{
            ...
            opacity: isDark ? Math.random() * 0.15 + 0.05 : Math.random() * 0.1 + 0.05,
